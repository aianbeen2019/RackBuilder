...
public static class NPCBuilder
{
	...
	private static Technician SpawnTechnician(TechnicianManager techMgr, MainGameManager mgr)
	{
		...
		try
		{
			...
			component.transformContainer = techMgr.transformContainer;
			component.transformDumpster = techMgr.transformDumpster;
			component.transformDeviceSpawnPosition = techMgr.transformDeviceSpawnPosition;
